...

{
  ...
  ShowMessage( "Начало положено от " + FloatToStr( frvUserDouble->DoubleDiapazon.Begin ) +
               " до "                + FloatToStr( frvUserDouble->DoubleDiapazon.End ) );
}
//---------------------------------------------------------------------------
...

{
  ...
  ShowMessage( "Начало положено от " + frvUserPeriod->Period.Begin.DateString() +
               " до "                + frvUserPeriod->Period.End.DateString() );
}
//---------------------------------------------------------------------------

void __fastcall TfmvExplorer::frvIntDiapazon1aSetDiapazonExecute(TObject *Sender)

{
  frvIntDiapazon1->aApplyDiapazonExecute( frvIntDiapazon1 );
  ShowMessage( "От "  + IntToStr( frvIntDiapazon1->IntDiapazon.Begin ) +
               " до " + IntToStr( frvIntDiapazon1->IntDiapazon.End ) );
}
//---------------------------------------------------------------------------

void __fastcall TfmvExplorer::frvShortIntDiapazon1aSetDiapazonExecute(TObject *Sender)

{
  frvShortIntDiapazon1->aApplyDiapazonExecute( frvShortIntDiapazon1 );
  ShowMessage( "От "  + IntToStr( frvShortIntDiapazon1->ShortIntDiapazon.Begin ) +
               " до " + IntToStr( frvShortIntDiapazon1->ShortIntDiapazon.End ) );
}
//---------------------------------------------------------------------------

void __fastcall TfmvExplorer::frvLongLongIntDiapazon1aSetDiapazonExecute(TObject *Sender)

{
  frvLongLongIntDiapazon1->aApplyDiapazonExecute( frvLongLongIntDiapazon1 );
  ShowMessage( "От "  + IntToStr( frvLongLongIntDiapazon1->LongLongIntDiapazon.Begin ) +
               " до " + IntToStr( frvLongLongIntDiapazon1->LongLongIntDiapazon.End ) );
}
//---------------------------------------------------------------------------
