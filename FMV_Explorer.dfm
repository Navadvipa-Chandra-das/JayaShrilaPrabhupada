inherited fmvExplorer: TfmvExplorer
  ...
  object paLanguages: TNNVPanel [8]
    Left = 192
    Top = 57
    Width = 993
    Height = 695
  ...
  object paGolovolomka15: TNNVPanel [10]
    Left = 192
    Top = 57
    Width = 993
    Height = 695
    ...
    object tbrGolovolomka15: TToolBar
      ...
      Images = dmvNewNavadvipa.ilDB
      TabOrder = 1
      object tbGolovolomka15StartPosition: TToolButton
        Left = 0
        Top = 0
        Action = aGolovolomka15StartPosition
      end
      object tbGolovolomka15Mix: TToolButton
        Left = 23
        Top = 0
    ...
    object dgUsers: TNNVDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Width = 100
          Visible = True
          OrderBy = '(a."Anketa")."INN"'
        end
        item
          Expanded = False
          FieldName = 'Anketa.Passport'
          Visible = True
          OrderBy = '(a."Anketa")."Passport"'
        end
        item
          Expanded = False
          ...
          Width = 100
          Visible = True
          OrderBy = '(a."Anketa")."PassportKemVydan"'
        end
        item
          ButtonStyle = cbsEllipsis
          Expanded = False
  ...
  inherited alRes: TNNVActionList
    ...
    object aGolovolomka15Mix: TAction
      Category = 'Golobolomka15'
      Caption = #1043#1086#1083#1086#1074#1086#1083#1086#1084#1082#1072' 15'
      Hint = #1043#1086#1083#1086#1074#1086#1083#1086#1084#1082#1072' 15'
      ImageIndex = 167
